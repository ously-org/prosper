...
- **Context-Aware:** Always refer to the `web/conductor/` directory for product specs and workflow guidelines.
...
- **Source of Truth:** This file (`AGENTS.md`) and the `web/conductor/` folder are your primary sources for project intent.
